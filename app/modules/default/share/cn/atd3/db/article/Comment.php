...
class Comment
{
    ...
    public static function create(int $article, int $author, string $text, int $state=self::STATE_PUBLISH)
    {
    ...
    public static function list(int $article,string $field='count',int $type=SORT_ASC,int $page=1, int $count=10)
    {
    ...
    public static function listAfter(int $article,int $id=1, string $field='count',int $type=SORT_ASC,int $count=10)
    {
        if (!in_array($field, ['reply', 'time', 'count'])) {
            $field='count';
        }
