...
INSERT INTO `mc_client` (`id`,`ip`,`machine`,`black`,`offset`,`length`,`crc32`,`last`,`online`) VALUES ;
...
INSERT INTO `mc_key` (`id`,`type`,`key`) VALUES ;
...
INSERT INTO `mc_keywords` (`id`,`type`,`key`) VALUES ;
...
INSERT INTO `mc_user` (`id`,`name`,`password`,`group`) VALUES ;
