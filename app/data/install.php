...
if ($create->erron()==0){
 ...
 (new Query('DROP TABLE IF EXISTS #{client}'))->exec();
  ...
  KEY `black` (`black`)
        ...
        }/* Table mc_client's Values Cann't Get */ (new Query('DROP TABLE IF EXISTS #{key}'))->exec();
  ...
  KEY `key` (`key`)
        ...
        }/* Table mc_key's Values Cann't Get */ (new Query('DROP TABLE IF EXISTS #{keywords}'))->exec();
  ...
  KEY `key` (`key`)
        ...
        }/* Table mc_keywords's Values Cann't Get */ (new Query('DROP TABLE IF EXISTS #{user}'))->exec();
  ...
  KEY `group` (`group`)
        ...
        }/* Table mc_user's Values Cann't Get *//** End Querys **/
Query::commit();
return true;
} 
catch (Exception $e)
